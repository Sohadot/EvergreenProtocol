...
| `site/reference-decay/index.html` | Reference Decay — core term page defining the central problem: the loss of validity, traceability, citation stability, or operational reliability of a digital reference over time; includes AI agent governance distinction, common decay forms, and Evergreen Protocol reading. |
| `site/briefs/reference-decay-in-ai-documentation/index.html` | Reference Decay in AI Documentation — Intelligence Brief 001: four operational cases of reference decay in enterprise AI documentation (unversioned model card, policy URL that still loads, agent citation from stale knowledge, definition divergence across departments); includes compound governance exposure analysis and governance gap distinction between model risk and reference continuity governance. |
| `site/briefs/agentic-systems-and-reference-continuity/index.html` | Agentic Systems and Reference Continuity — Intelligence Brief 002: five operational cases in which an enterprise agent executes correctly while the reference it acts on has decayed (stale approval rule, contradictory vendor definition, silent risk-threshold update, machine-readable drift, archived-but-still-cited reference); includes three-failure-mode taxonomy distinguishing model failure, execution failure, and reference failure; six dimensions of why agents make reference decay worse; and seven-dimension Evergreen Protocol reading. |
| `site/operator-use-cases/enterprise-ai-governance/index.html` | Enterprise AI Governance Use Case — operator use case page describing where reference decay appears in AI governance documentation (model cards, AI usage policies, prompt guidelines, data-use policies, risk registers, vendor definitions, internal knowledge bases, machine-readable governance files) and how Evergreen Protocol operates as a reference continuity layer; includes governing blockquote distinguishing model governance from reference continuity, practical operating pattern across seven dimensions, seven-step example workflow, and non-claim section. |
